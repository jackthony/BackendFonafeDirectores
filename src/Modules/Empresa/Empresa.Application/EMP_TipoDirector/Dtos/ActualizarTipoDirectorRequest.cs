/*****
 * Nombre del archivo:  ActualizarTipoDirectorRequest.cs
 * Descripción:         DTO que representa la solicitud para actualizar un tipo de director.
 *                      Implementa ITrackableRequest para permitir el seguimiento de auditoría
 *                      del movimiento de actualización sobre la tabla EMP_TipoDirector.
 * Autor:               Daniel Alva
