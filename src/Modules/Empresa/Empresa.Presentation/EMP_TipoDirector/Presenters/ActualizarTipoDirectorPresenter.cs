...
{
    public class ActualizarTipoDirectorPresenter : IPresenter<
    ActualizarTipoDirectorClientRequest,
    ActualizarTipoDirectorRequest,
    SpResultBase,
    ItemResponse<bool>>
    {
        public ActualizarTipoDirectorRequest ToRequest(ActualizarTipoDirectorClientRequest clientRequest)
        {
