...
{
    public class ActualizarAccionPresenter : IPresenter<
        ActualizarAccionClientRequest,
        ActualizarAccionRequest,
        SpResultBase,
        ItemResponse<bool>>
    {
        public ActualizarAccionRequest ToRequest(ActualizarAccionClientRequest clientRequest)
        {
